...
2. [Write a PHP script to demonstrate arithmetic operators, comparison operators, and logical operators.](2_arithmetic_comparison_logical_operators.php)
3. [Write a PHP Script to input marks, generate results, and display grades.](3_input_marks_generate_results.php)
...
8. [Write two different PHP scripts to demonstrate passing variables through a URL.](8_passing_variables_through_url.php)
9. [Write two different PHP scripts to demonstrate passing variables with sessions.](9_passing_variables_with_sessions.php)
10. [Write PHP script to demonstrate passing variables with cookies.](10_passing_variables_with_cookies.php)
11. [Write a program to keep track of how many times a visitor has loaded the page.](11_track_page_visits.php)
